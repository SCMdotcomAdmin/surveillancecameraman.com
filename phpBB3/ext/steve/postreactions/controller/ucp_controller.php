...
class ucp_controller implements ucp_interface
{
	...
	{	
		...
		if ($enable_thanks)
		{
			$this->language->add_lang('ucp_thanks', 'steve/postreactions');
		}
		else
		{
			$this->language->add_lang('ucp_reactions', 'steve/postreactions');
		}
		...
		$this->template->assign_vars([
			...
			'S_USER_ENABLE_FOE_REACTIONS'	=> !empty($data['user_enable_foe_reactions']) ? true : false,
