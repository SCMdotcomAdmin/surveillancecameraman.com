...
/* overall_header.html */
class __TwigTemplate_de90d941096a055b4bdbd0a691a426586047c0e0cce988df587c5398fa27361d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $this->env->loadTemplate('@forumflair_discencql/event/overall_header_head_append.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        $this->env->setNamespaceLookUpOrder(array('pcgf_ajaxregistrationcheck', '__main__'));
        $this->env->loadTemplate('@pcgf_ajaxregistrationcheck/event/overall_header_head_append.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        ...
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        $this->env->setNamespaceLookUpOrder(array('senky_avatarsonmemberlist', '__main__'));
        $this->env->loadTemplate('@senky_avatarsonmemberlist/event/overall_header_head_append.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        $this->env->setNamespaceLookUpOrder(array('senky_massnotification', '__main__'));
        $this->env->loadTemplate('@senky_massnotification/event/overall_header_head_append.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
...
";
        ...
        $this->env->loadTemplate('@phpbb_mediaembed/event/overall_header_stylesheets_after.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        // line 73
        echo "
</head>
...
\t\t";
    ...
    {
        return array (  489 => 135,  486 => 134,  476 => 130,  472 => 128,  470 => 127,  465 => 124,  460 => 123,  454 => 119,  441 => 118,  436 => 117,  433 => 116,  432 => 115,  428 => 113,  426 => 112,  418 => 107,  413 => 105,  407 => 104,  402 => 102,  398 => 101,  390 => 100,  385 => 98,  382 => 97,  379 => 96,  378 => 95,  372 => 92,  368 => 91,  364 => 90,  348 => 87,  343 => 84,  342 => 83,  335 => 78,  330 => 77,  321 => 75,  317 => 73,  304 => 72,  299 => 70,  296 => 69,  267 => 68,  259 => 65,  255 => 63,  247 => 61,  245 => 60,  242 => 59,  234 => 57,  232 => 56,  229 => 55,  221 => 53,  219 => 52,  214 => 50,  210 => 49,  205 => 48,  188 => 33,  186 => 32,  176 => 24,  170 => 22,  168 => 21,  165 => 20,  162 => 18,  149 => 17,  136 => 16,  125 => 15,  114 => 14,  103 => 13,  92 => 12,  81 => 11,  79 => 10,  54 => 8,  50 => 7,  40 => 2,  37 => 1,);
    }
