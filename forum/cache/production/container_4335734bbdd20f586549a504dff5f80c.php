...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'forumflair.discencql.listener' => 'getForumflair_Discencql_ListenerService',
            ...
            'pcgf.ajaxregistrationcheck.controller' => 'getPcgf_Ajaxregistrationcheck_ControllerService',
            'pcgf.ajaxregistrationcheck.listener' => 'getPcgf_Ajaxregistrationcheck_ListenerService',
            'php_ini' => 'getPhpIniService',
            'phpbb.ads.ad.manager' => 'getPhpbb_Ads_Ad_ManagerService',
            'phpbb.ads.admin.controller' => 'getPhpbb_Ads_Admin_ControllerService',
            'phpbb.ads.admin.input' => 'getPhpbb_Ads_Admin_InputService',
            'phpbb.ads.analyser.manager' => 'getPhpbb_Ads_Analyser_ManagerService',
            'phpbb.ads.analyser.test.alert' => 'getPhpbb_Ads_Analyser_Test_AlertService',
            'phpbb.ads.analyser.test.location_href' => 'getPhpbb_Ads_Analyser_Test_LocationHrefService',
            'phpbb.ads.analyser.test.script_without_async' => 'getPhpbb_Ads_Analyser_Test_ScriptWithoutAsyncService',
            'phpbb.ads.analyser.test.untrusted_connection' => 'getPhpbb_Ads_Analyser_Test_UntrustedConnectionService',
            'phpbb.ads.analyser.test_collection' => 'getPhpbb_Ads_Analyser_TestCollectionService',
            'phpbb.ads.banner.banner' => 'getPhpbb_Ads_Banner_BannerService',
            'phpbb.ads.helper' => 'getPhpbb_Ads_HelperService',
            'phpbb.ads.increment.controller' => 'getPhpbb_Ads_Increment_ControllerService',
            'phpbb.ads.listener' => 'getPhpbb_Ads_ListenerService',
            'phpbb.ads.location.manager' => 'getPhpbb_Ads_Location_ManagerService',
            'phpbb.ads.location.type.above_footer' => 'getPhpbb_Ads_Location_Type_AboveFooterService',
            'phpbb.ads.location.type.above_header' => 'getPhpbb_Ads_Location_Type_AboveHeaderService',
            'phpbb.ads.location.type.after_first_post' => 'getPhpbb_Ads_Location_Type_AfterFirstPostService',
            'phpbb.ads.location.type.after_footer_navbar' => 'getPhpbb_Ads_Location_Type_AfterFooterNavbarService',
            'phpbb.ads.location.type.after_header_navbar' => 'getPhpbb_Ads_Location_Type_AfterHeaderNavbarService',
            'phpbb.ads.location.type.after_not_first_post' => 'getPhpbb_Ads_Location_Type_AfterNotFirstPostService',
            'phpbb.ads.location.type.after_posts' => 'getPhpbb_Ads_Location_Type_AfterPostsService',
            'phpbb.ads.location.type.after_profile' => 'getPhpbb_Ads_Location_Type_AfterProfileService',
            'phpbb.ads.location.type.after_quickreply' => 'getPhpbb_Ads_Location_Type_AfterQuickreplyService',
            'phpbb.ads.location.type.before_posts' => 'getPhpbb_Ads_Location_Type_BeforePostsService',
            'phpbb.ads.location.type.before_profile' => 'getPhpbb_Ads_Location_Type_BeforeProfileService',
            'phpbb.ads.location.type.before_quickreply' => 'getPhpbb_Ads_Location_Type_BeforeQuickreplyService',
            'phpbb.ads.location.type.below_footer' => 'getPhpbb_Ads_Location_Type_BelowFooterService',
            'phpbb.ads.location.type.below_header' => 'getPhpbb_Ads_Location_Type_BelowHeaderService',
            'phpbb.ads.location.type.pop_up' => 'getPhpbb_Ads_Location_Type_PopUpService',
            'phpbb.ads.location.type.scripts' => 'getPhpbb_Ads_Location_Type_ScriptsService',
            'phpbb.ads.location.type.slide_up' => 'getPhpbb_Ads_Location_Type_SlideUpService',
            'phpbb.ads.location.type_collection' => 'getPhpbb_Ads_Location_TypeCollectionService',
            'phpbb.ads.ucp.controller' => 'getPhpbb_Ads_Ucp_ControllerService',
            'phpbb.ads.visual_demo.controller' => 'getPhpbb_Ads_VisualDemo_ControllerService',
            ...
            'phpbb.mediaembed.cache' => 'getPhpbb_Mediaembed_CacheService',
            'phpbb.mediaembed.cron.task.purge_cache' => 'getPhpbb_Mediaembed_Cron_Task_PurgeCacheService',
            'phpbb.mediaembed.customsitescollection' => 'getPhpbb_Mediaembed_CustomsitescollectionService',
            'phpbb.mediaembed.listener' => 'getPhpbb_Mediaembed_ListenerService',
            ...
            'rmcgirr83.elonw.listener' => 'getRmcgirr83_Elonw_ListenerService',
            ...
            'senky.massnotification.listener' => 'getSenky_Massnotification_ListenerService',
            'senky.massnotification.notification.type.manual' => 'getSenky_Massnotification_Notification_Type_ManualService',
            'sitesplat.cloudflareip.listener' => 'getSitesplat_Cloudflareip_ListenerService',
        ...
        $this->privates = [
            ...
            'files.upload' => true,
            'filesystem' => true,
            'forumflair.discencql.listener' => true,
            'gfksx.thanksforposts.controller.thankslist' => true,
            'gfksx.thanksforposts.controller.toplist' => true,
            'gfksx.thanksforposts.helper' => true,
            'gfksx.thanksforposts.listener' => true,
            'gfksx.thanksforposts.notification.type.thanks' => true,
            'gfksx.thanksforposts.notification.type.thanks_remove' => true,
            'group_helper' => true,
            ...
            'path_helper' => true,
            'pcgf.ajaxregistrationcheck.controller' => true,
            'pcgf.ajaxregistrationcheck.listener' => true,
            'php_ini' => true,
            'phpbb.ads.ad.manager' => true,
            'phpbb.ads.admin.controller' => true,
            'phpbb.ads.admin.input' => true,
            'phpbb.ads.analyser.manager' => true,
            'phpbb.ads.analyser.test.alert' => true,
            'phpbb.ads.analyser.test.location_href' => true,
            'phpbb.ads.analyser.test.script_without_async' => true,
            'phpbb.ads.analyser.test.untrusted_connection' => true,
            'phpbb.ads.analyser.test_collection' => true,
            'phpbb.ads.banner.banner' => true,
            'phpbb.ads.helper' => true,
            'phpbb.ads.increment.controller' => true,
            'phpbb.ads.listener' => true,
            'phpbb.ads.location.manager' => true,
            'phpbb.ads.location.type.above_footer' => true,
            'phpbb.ads.location.type.above_header' => true,
            'phpbb.ads.location.type.after_first_post' => true,
            'phpbb.ads.location.type.after_footer_navbar' => true,
            'phpbb.ads.location.type.after_header_navbar' => true,
            'phpbb.ads.location.type.after_not_first_post' => true,
            'phpbb.ads.location.type.after_posts' => true,
            'phpbb.ads.location.type.after_profile' => true,
            'phpbb.ads.location.type.after_quickreply' => true,
            'phpbb.ads.location.type.before_posts' => true,
            'phpbb.ads.location.type.before_profile' => true,
            'phpbb.ads.location.type.before_quickreply' => true,
            'phpbb.ads.location.type.below_footer' => true,
            'phpbb.ads.location.type.below_header' => true,
            'phpbb.ads.location.type.pop_up' => true,
            'phpbb.ads.location.type.scripts' => true,
            'phpbb.ads.location.type.slide_up' => true,
            'phpbb.ads.location.type_collection' => true,
            'phpbb.ads.ucp.controller' => true,
            'phpbb.ads.visual_demo.controller' => true,
            'phpbb.feed.controller' => true,
            'phpbb.googleanalytics.listener' => true,
            'phpbb.help.controller.bbcode' => true,
            'phpbb.help.controller.faq' => true,
            'phpbb.help.manager' => true,
            'phpbb.mediaembed.cache' => true,
            'phpbb.mediaembed.cron.task.purge_cache' => true,
            'phpbb.mediaembed.customsitescollection' => true,
            'phpbb.mediaembed.listener' => true,
            ...
            'senky.massnotification.listener' => true,
            'senky.massnotification.notification.type.manual' => true,
            'sitesplat.cloudflareip.listener' => true,
    ...
    public function getRemovedIds()
    {
        return [
            ...
            'phpbb.ads.location.type.after_profile' => true,
            'phpbb.ads.location.type.after_quickreply' => true,
            'phpbb.ads.location.type.base' => true,
            'phpbb.ads.location.type.before_posts' => true,
            'phpbb.ads.location.type.before_profile' => true,
            'phpbb.ads.location.type.before_quickreply' => true,
            'phpbb.ads.location.type.below_footer' => true,
    ...
    protected function getCron_TaskCollectionService()
    {
        ...
        $instance->add('phpbb.mediaembed.cron.task.purge_cache');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['forumflair.discencql.listener']) ? $this->services['forumflair.discencql.listener'] : $this->getForumflair_Discencql_ListenerService()) && false ?: '_'};
        }, 1 => 'load_lang'], 0);
        $instance->addListener('core.index_modify_page_title', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'get_thanks_list'], 0);
        $instance->addListener('core.memberlist_view_profile', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'memberlist_viewprofile'], 0);
        $instance->addListener('core.delete_posts_in_transaction', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'delete_post_thanks'], 0);
        $instance->addListener('core.viewforum_modify_topicrow', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'viewforum_output_topics_reput'], 0);
        $instance->addListener('core.viewforum_modify_topics_data', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'viewforum_get_topics_reput'], 0);
        $instance->addListener('core.viewtopic_get_post_data', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'viewtopic_handle_thanks'], -2);
        $instance->addListener('core.viewtopic_modify_post_row', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'viewtopic_modify_postrow'], 0);
        $instance->addListener('core.display_forums_before', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'forumlist_display_rating'], 0);
        $instance->addListener('core.display_forums_modify_template_vars', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'forumlist_modify_template_vars'], 0);
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'load_language_on_setup'], 0);
        $instance->addListener('core.page_header_after', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'add_header_quicklinks'], 0);
        ...
        $instance->addListener('core.viewtopic_assign_template_vars_before', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'viewtopic_check_f_thanks_auth'], 0);
        $instance->addListener('paybas.recenttopics.modify_tpl_ary', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'recenttopics_output_topics_reput'], 0);
        $instance->addListener('paybas.recenttopics.modify_topics_list', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'recenttopics_get_topics_reput'], 0);
        $instance->addListener('core.permissions', [0 => function () {
            return ${($_ = isset($this->services['gfksx.thanksforposts.listener']) ? $this->services['gfksx.thanksforposts.listener'] : $this->getGfksx_Thanksforposts_ListenerService()) && false ?: '_'};
        }, 1 => 'add_permission'], 0);
        $instance->addListener('core.ucp_register_data_before', [0 => function () {
            return ${($_ = isset($this->services['pcgf.ajaxregistrationcheck.listener']) ? $this->services['pcgf.ajaxregistrationcheck.listener'] : $this->getPcgf_Ajaxregistrationcheck_ListenerService()) && false ?: '_'};
        }, 1 => 'assign_register_data'], 0);
        $instance->addListener('core.permissions', [0 => function () {
            return ${($_ = isset($this->services['phpbb.ads.listener']) ? $this->services['phpbb.ads.listener'] : $this->getPhpbb_Ads_ListenerService()) && false ?: '_'};
        }, 1 => 'set_permissions'], 0);
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['phpbb.ads.listener']) ? $this->services['phpbb.ads.listener'] : $this->getPhpbb_Ads_ListenerService()) && false ?: '_'};
        }, 1 => 'load_language_on_setup'], 0);
        $instance->addListener('core.page_footer_after', [0 => function () {
            return ${($_ = isset($this->services['phpbb.ads.listener']) ? $this->services['phpbb.ads.listener'] : $this->getPhpbb_Ads_ListenerService()) && false ?: '_'};
        }, 1 => 'setup_ads'], 0);
        $instance->addListener('core.page_footer_after', [0 => function () {
            return ${($_ = isset($this->services['phpbb.ads.listener']) ? $this->services['phpbb.ads.listener'] : $this->getPhpbb_Ads_ListenerService()) && false ?: '_'};
        ...
        $instance->addListener('core.adm_page_header_after', [0 => function () {
            return ${($_ = isset($this->services['phpbb.ads.listener']) ? $this->services['phpbb.ads.listener'] : $this->getPhpbb_Ads_ListenerService()) && false ?: '_'};
        }, 1 => 'disable_xss_protection'], 0);
        $instance->addListener('core.group_add_user_after', [0 => function () {
            return ${($_ = isset($this->services['phpbb.ads.listener']) ? $this->services['phpbb.ads.listener'] : $this->getPhpbb_Ads_ListenerService()) && false ?: '_'};
        }, 1 => 'destroy_user_group_cache'], 0);
        $instance->addListener('core.group_delete_user_after', [0 => function () {
            return ${($_ = isset($this->services['phpbb.ads.listener']) ? $this->services['phpbb.ads.listener'] : $this->getPhpbb_Ads_ListenerService()) && false ?: '_'};
        }, 1 => 'destroy_user_group_cache'], 0);
        $instance->addListener('core.acp_board_config_edit_add', [0 => function () {
            return ${($_ = isset($this->services['phpbb.googleanalytics.listener']) ? $this->services['phpbb.googleanalytics.listener'] : $this->getPhpbb_Googleanalytics_ListenerService()) && false ?: '_'};
        }, 1 => 'add_googleanalytics_configs'], 0);
        $instance->addListener('core.page_header', [0 => function () {
            return ${($_ = isset($this->services['phpbb.googleanalytics.listener']) ? $this->services['phpbb.googleanalytics.listener'] : $this->getPhpbb_Googleanalytics_ListenerService()) && false ?: '_'};
        }, 1 => 'load_google_analytics'], 0);
        $instance->addListener('core.validate_config_variable', [0 => function () {
            return ${($_ = isset($this->services['phpbb.googleanalytics.listener']) ? $this->services['phpbb.googleanalytics.listener'] : $this->getPhpbb_Googleanalytics_ListenerService()) && false ?: '_'};
        }, 1 => 'validate_googleanalytics_id'], 0);
        $instance->addListener('core.text_formatter_s9e_configure_after', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'add_custom_sites'], 3);
        $instance->addListener('core.text_formatter_s9e_configure_after', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'enable_media_sites'], 2);
        $instance->addListener('core.text_formatter_s9e_configure_after', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'configure_url_parsing'], 1);
        $instance->addListener('core.display_custom_bbcodes', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'setup_media_bbcode'], 0);
        $instance->addListener('core.permissions', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'set_permissions'], 0);
        $instance->addListener('core.help_manager_add_block_before', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'media_embed_help'], 0);
        $instance->addListener('core.posting_modify_message_text', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'check_forum_permission'], 0);
        $instance->addListener('core.ucp_pm_compose_modify_parse_before', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'check_pm_permission'], 0);
        $instance->addListener('core.message_parser_check_message', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'check_signature'], 0);
        $instance->addListener('core.message_parser_check_message', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'check_magic_urls'], 0);
        $instance->addListener('core.message_parser_check_message', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'check_bbcode_enabled'], 0);
        $instance->addListener('core.text_formatter_s9e_parser_setup', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'disable_media_embed'], 0);
        $instance->addListener('core.text_formatter_s9e_parser_setup', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'setup_cache_dir'], 0);
        $instance->addListener('core.page_header', [0 => function () {
            return ${($_ = isset($this->services['phpbb.mediaembed.listener']) ? $this->services['phpbb.mediaembed.listener'] : $this->getPhpbb_Mediaembed_ListenerService()) && false ?: '_'};
        }, 1 => 'setup_media_configs'], 0);
        ...
        $instance->addListener('core.acp_extensions_run_action_after', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.elonw.listener']) ? $this->services['rmcgirr83.elonw.listener'] : $this->getRmcgirr83_Elonw_ListenerService()) && false ?: '_'};
        ...
        $instance->addListener('core.ucp_prefs_personal_data', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.elonw.listener']) ? $this->services['rmcgirr83.elonw.listener'] : $this->getRmcgirr83_Elonw_ListenerService()) && false ?: '_'};
        }, 1 => 'ucp_prefs_get_data'], 0);
        $instance->addListener('core.ucp_prefs_personal_update_data', [0 => function () {
            return ${($_ = isset($this->services['rmcgirr83.elonw.listener']) ? $this->services['rmcgirr83.elonw.listener'] : $this->getRmcgirr83_Elonw_ListenerService()) && false ?: '_'};
        }, 1 => 'ucp_prefs_set_data'], 0);
        $instance->addListener('core.index_mark_notification_after', [0 => function () {
            return ${($_ = isset($this->services['senky.massnotification.listener']) ? $this->services['senky.massnotification.listener'] : $this->getSenky_Massnotification_ListenerService()) && false ?: '_'};
        }, 1 => 'redirect_external_url'], 0);
        $instance->addListener('core.session_ip_after', [0 => function () {
            return ${($_ = isset($this->services['sitesplat.cloudflareip.listener']) ? $this->services['sitesplat.cloudflareip.listener'] : $this->getSitesplat_Cloudflareip_ListenerService()) && false ?: '_'};
        }, 1 => 'cloudflare_ip_support'], 0);
        $instance->addListener('core.common', [0 => function () {
            return ${($_ = isset($this->services['vinny.shareon.listener']) ? $this->services['vinny.shareon.listener'] : $this->getVinny_Shareon_ListenerService()) && false ?: '_'};
        }, 1 => 'common_setup'], 0);
        $instance->addListener('core.viewtopic_modify_post_row', [0 => function () {
            return ${($_ = isset($this->services['vinny.shareon.listener']) ? $this->services['vinny.shareon.listener'] : $this->getVinny_Shareon_ListenerService()) && false ?: '_'};
        }, 1 => 'viewtopic_postrow_shareon'], 0);
        $instance->addListener('core.user_setup', [0 => function () {
        ...
        $instance->addListener('core.page_header', [0 => function () {
            return ${($_ = isset($this->services['vse.abbc3.listener']) ? $this->services['vse.abbc3.listener'] : $this->getVse_Abbc3_ListenerService()) && false ?: '_'};
        }, 1 => 'load_google_fonts'], 0);
        $instance->addListener('core.adm_page_header', [0 => function () {
            return ${($_ = isset($this->services['vse.abbc3.listener']) ? $this->services['vse.abbc3.listener'] : $this->getVse_Abbc3_ListenerService()) && false ?: '_'};
        }, 1 => 'load_google_fonts'], 0);
        $instance->addListener('core.display_custom_bbcodes', [0 => function () {
            return ${($_ = isset($this->services['vse.abbc3.listener']) ? $this->services['vse.abbc3.listener'] : $this->getVse_Abbc3_ListenerService()) && false ?: '_'};
    ...
    /**
     * Gets the private 'forumflair.discencql.listener' shared service.
     *
     * @return \forumflair\discencql\event\main_listener
     */
    protected function getForumflair_Discencql_ListenerService()
    {
        return $this->services['forumflair.discencql.listener'] = new \forumflair\discencql\event\main_listener(${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'gfksx.thanksforposts.controller.thankslist' shared service.
     *
     * @return \gfksx\thanksforposts\controller\thankslist
     */
    protected function getGfksx_Thanksforposts_Controller_ThankslistService()
    {
        return $this->services['gfksx.thanksforposts.controller.thankslist'] = new \gfksx\thanksforposts\controller\thankslist(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, ${($_ = isset($this->services['pagination']) ? $this->services['pagination'] : $this->getPaginationService()) && false ?: '_'}, ${($_ = isset($this->services['profilefields.manager']) ? $this->services['profilefields.manager'] : $this->getProfilefields_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, 'phpBB_posts', 'phpBB_thanks', 'phpBB_sessions', 'phpBB_users', './', 'php');
    }

    /**
     * Gets the private 'gfksx.thanksforposts.controller.toplist' shared service.
     *
     * @return \gfksx\thanksforposts\controller\toplist
     */
    protected function getGfksx_Thanksforposts_Controller_ToplistService()
    {
        return $this->services['gfksx.thanksforposts.controller.toplist'] = new \gfksx\thanksforposts\controller\toplist(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, './', 'php', ${($_ = isset($this->services['pagination']) ? $this->services['pagination'] : $this->getPaginationService()) && false ?: '_'}, ${($_ = isset($this->services['gfksx.thanksforposts.helper']) ? $this->services['gfksx.thanksforposts.helper'] : $this->getGfksx_Thanksforposts_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, 'phpBB_forums', 'phpBB_thanks', 'phpBB_users', 'phpBB_posts');
    }

    /**
     * Gets the private 'gfksx.thanksforposts.helper' shared service.
     *
     * @return \gfksx\thanksforposts\core\helper
     */
    protected function getGfksx_Thanksforposts_HelperService()
    {
        return $this->services['gfksx.thanksforposts.helper'] = new \gfksx\thanksforposts\core\helper(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['notification_manager']) ? $this->services['notification_manager'] : $this->getNotificationManagerService()) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, './', 'php', 'phpBB_thanks', 'phpBB_users', 'phpBB_posts', 'phpBB_notifications');
    }

    /**
     * Gets the private 'gfksx.thanksforposts.listener' shared service.
     *
     * @return \gfksx\thanksforposts\event\listener
     */
    ...
    /**
     * Gets the private 'gfksx.thanksforposts.notification.type.thanks' service.
     *
     * @return \gfksx\thanksforposts\notification\thanks
     */
    protected function getGfksx_Thanksforposts_Notification_Type_ThanksService()
    {
        ...
        $instance->set_notifications_table('phpBB_notifications');

        return $instance;
    }

    /**
     * Gets the private 'gfksx.thanksforposts.notification.type.thanks_remove' service.
     *
    ...
    protected function getNotification_TypeCollectionService()
    {
        ...
        $instance->add('senky.massnotification.notification.type.manual');
    ...
    /**
     * Gets the private 'pcgf.ajaxregistrationcheck.controller' shared service.
     *
     * @return \pcgf\ajaxregistrationcheck\controller\controller
     */
    protected function getPcgf_Ajaxregistrationcheck_ControllerService()
    {
        return $this->services['pcgf.ajaxregistrationcheck.controller'] = new \pcgf\ajaxregistrationcheck\controller\controller(${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'});
    }

    /**
     * Gets the private 'pcgf.ajaxregistrationcheck.listener' shared service.
     *
     * @return \pcgf\ajaxregistrationcheck\event\listener
     */
    protected function getPcgf_Ajaxregistrationcheck_ListenerService()
    {
        return $this->services['pcgf.ajaxregistrationcheck.listener'] = new \pcgf\ajaxregistrationcheck\event\listener(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'phpbb.ads.ad.manager' shared service.
     *
     * @return \phpbb\ads\ad\manager
     */
    protected function getPhpbb_Ads_Ad_ManagerService()
    {
        return $this->services['phpbb.ads.ad.manager'] = new \phpbb\ads\ad\manager(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, 'phpBB_ads', 'phpBB_ad_locations', 'phpBB_ad_group');
    }

    /**
     * Gets the private 'phpbb.ads.admin.controller' shared service.
     *
     * @return \phpbb\ads\controller\admin_controller
     */
    protected function getPhpbb_Ads_Admin_ControllerService()
    {
        return $this->services['phpbb.ads.admin.controller'] = new \phpbb\ads\controller\admin_controller(${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.ad.manager']) ? $this->services['phpbb.ads.ad.manager'] : $this->getPhpbb_Ads_Ad_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['config_text']) ? $this->services['config_text'] : $this->getConfigTextService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.admin.input']) ? $this->services['phpbb.ads.admin.input'] : $this->getPhpbb_Ads_Admin_InputService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.helper']) ? $this->services['phpbb.ads.helper'] : $this->getPhpbb_Ads_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.analyser.manager']) ? $this->services['phpbb.ads.analyser.manager'] : $this->getPhpbb_Ads_Analyser_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, './', 'php');
    }

    /**
     * Gets the private 'phpbb.ads.admin.input' shared service.
     *
     * @return \phpbb\ads\controller\admin_input
     */
    protected function getPhpbb_Ads_Admin_InputService()
    {
        return $this->services['phpbb.ads.admin.input'] = new \phpbb\ads\controller\admin_input(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.banner.banner']) ? $this->services['phpbb.ads.banner.banner'] : $this->getPhpbb_Ads_Banner_BannerService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.analyser.manager' shared service.
     *
     * @return \phpbb\ads\analyser\manager
     */
    protected function getPhpbb_Ads_Analyser_ManagerService()
    {
        return $this->services['phpbb.ads.analyser.manager'] = new \phpbb\ads\analyser\manager(${($_ = isset($this->services['phpbb.ads.analyser.test_collection']) ? $this->services['phpbb.ads.analyser.test_collection'] : $this->getPhpbb_Ads_Analyser_TestCollectionService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.analyser.test.alert' shared service.
     *
     * @return \phpbb\ads\analyser\test\alert
     */
    protected function getPhpbb_Ads_Analyser_Test_AlertService()
    {
        return $this->services['phpbb.ads.analyser.test.alert'] = new \phpbb\ads\analyser\test\alert();
    }

    /**
     * Gets the private 'phpbb.ads.analyser.test.location_href' shared service.
     *
     * @return \phpbb\ads\analyser\test\location_href
     */
    protected function getPhpbb_Ads_Analyser_Test_LocationHrefService()
    {
        return $this->services['phpbb.ads.analyser.test.location_href'] = new \phpbb\ads\analyser\test\location_href();
    }

    /**
     * Gets the private 'phpbb.ads.analyser.test.script_without_async' shared service.
     *
     * @return \phpbb\ads\analyser\test\script_without_async
     */
    protected function getPhpbb_Ads_Analyser_Test_ScriptWithoutAsyncService()
    {
        return $this->services['phpbb.ads.analyser.test.script_without_async'] = new \phpbb\ads\analyser\test\script_without_async();
    }

    /**
     * Gets the private 'phpbb.ads.analyser.test.untrusted_connection' shared service.
     *
     * @return \phpbb\ads\analyser\test\untrusted_connection
     */
    protected function getPhpbb_Ads_Analyser_Test_UntrustedConnectionService()
    {
        return $this->services['phpbb.ads.analyser.test.untrusted_connection'] = new \phpbb\ads\analyser\test\untrusted_connection(${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.analyser.test_collection' shared service.
     *
     * @return \phpbb\di\service_collection
     */
    protected function getPhpbb_Ads_Analyser_TestCollectionService()
    {
        $this->services['phpbb.ads.analyser.test_collection'] = $instance = new \phpbb\di\service_collection($this);

        $instance->add('phpbb.ads.analyser.test.alert');
        $instance->add('phpbb.ads.analyser.test.location_href');
        $instance->add('phpbb.ads.analyser.test.script_without_async');
        $instance->add('phpbb.ads.analyser.test.untrusted_connection');

        return $instance;
    }

    /**
     * Gets the private 'phpbb.ads.banner.banner' shared service.
     *
     * @return \phpbb\ads\banner\banner
     */
    protected function getPhpbb_Ads_Banner_BannerService()
    {
        $a = ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'};

        return $this->services['phpbb.ads.banner.banner'] = new \phpbb\ads\banner\banner(new \phpbb\files\upload($a, ${($_ = isset($this->services['files.factory']) ? $this->services['files.factory'] : ($this->services['files.factory'] = new \phpbb\files\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['php_ini']) ? $this->services['php_ini'] : ($this->services['php_ini'] = new \bantu\IniGetWrapper\IniGetWrapper())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}), $a, './', 'phpBB_ad_locations');
    }

    /**
     * Gets the private 'phpbb.ads.helper' shared service.
     *
     * @return \phpbb\ads\controller\helper
     */
    protected function getPhpbb_Ads_HelperService()
    {
        return $this->services['phpbb.ads.helper'] = new \phpbb\ads\controller\helper(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.ad.manager']) ? $this->services['phpbb.ads.ad.manager'] : $this->getPhpbb_Ads_Ad_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.location.manager']) ? $this->services['phpbb.ads.location.manager'] : $this->getPhpbb_Ads_Location_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['group_helper']) ? $this->services['group_helper'] : $this->getGroupHelperService()) && false ?: '_'}, './', 'php');
    }

    /**
     * Gets the private 'phpbb.ads.increment.controller' shared service.
     *
     * @return \phpbb\ads\controller\increment_controller
     */
    protected function getPhpbb_Ads_Increment_ControllerService()
    {
        return $this->services['phpbb.ads.increment.controller'] = new \phpbb\ads\controller\increment_controller(${($_ = isset($this->services['phpbb.ads.ad.manager']) ? $this->services['phpbb.ads.ad.manager'] : $this->getPhpbb_Ads_Ad_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.listener' shared service.
     *
     * @return \phpbb\ads\event\main_listener
     */
    protected function getPhpbb_Ads_ListenerService()
    {
        return $this->services['phpbb.ads.listener'] = new \phpbb\ads\event\main_listener(${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['template_context']) ? $this->services['template_context'] : ($this->services['template_context'] = new \phpbb\template\context())) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.ad.manager']) ? $this->services['phpbb.ads.ad.manager'] : $this->getPhpbb_Ads_Ad_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.location.manager']) ? $this->services['phpbb.ads.location.manager'] : $this->getPhpbb_Ads_Location_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'php');
    }

    /**
     * Gets the private 'phpbb.ads.location.manager' shared service.
     *
     * @return \phpbb\ads\location\manager
     */
    protected function getPhpbb_Ads_Location_ManagerService()
    {
        return $this->services['phpbb.ads.location.manager'] = new \phpbb\ads\location\manager(${($_ = isset($this->services['phpbb.ads.location.type_collection']) ? $this->services['phpbb.ads.location.type_collection'] : $this->getPhpbb_Ads_Location_TypeCollectionService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.above_footer' shared service.
     *
     * @return \phpbb\ads\location\type\above_footer
     */
    protected function getPhpbb_Ads_Location_Type_AboveFooterService()
    {
        return $this->services['phpbb.ads.location.type.above_footer'] = new \phpbb\ads\location\type\above_footer(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.above_header' shared service.
     *
     * @return \phpbb\ads\location\type\above_header
     */
    protected function getPhpbb_Ads_Location_Type_AboveHeaderService()
    {
        return $this->services['phpbb.ads.location.type.above_header'] = new \phpbb\ads\location\type\above_header(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.after_first_post' shared service.
     *
     * @return \phpbb\ads\location\type\after_first_post
     */
    protected function getPhpbb_Ads_Location_Type_AfterFirstPostService()
    {
        return $this->services['phpbb.ads.location.type.after_first_post'] = new \phpbb\ads\location\type\after_first_post(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.after_footer_navbar' shared service.
     *
     * @return \phpbb\ads\location\type\after_footer_navbar
     */
    protected function getPhpbb_Ads_Location_Type_AfterFooterNavbarService()
    {
        return $this->services['phpbb.ads.location.type.after_footer_navbar'] = new \phpbb\ads\location\type\after_footer_navbar(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.after_header_navbar' shared service.
     *
     * @return \phpbb\ads\location\type\after_header_navbar
     */
    protected function getPhpbb_Ads_Location_Type_AfterHeaderNavbarService()
    {
        return $this->services['phpbb.ads.location.type.after_header_navbar'] = new \phpbb\ads\location\type\after_header_navbar(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.after_not_first_post' shared service.
     *
     * @return \phpbb\ads\location\type\after_not_first_post
     */
    protected function getPhpbb_Ads_Location_Type_AfterNotFirstPostService()
    {
        return $this->services['phpbb.ads.location.type.after_not_first_post'] = new \phpbb\ads\location\type\after_not_first_post(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.after_posts' shared service.
     *
     * @return \phpbb\ads\location\type\after_posts
     */
    protected function getPhpbb_Ads_Location_Type_AfterPostsService()
    {
        return $this->services['phpbb.ads.location.type.after_posts'] = new \phpbb\ads\location\type\after_posts(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.after_profile' shared service.
     *
     * @return \phpbb\ads\location\type\after_profile
     */
    protected function getPhpbb_Ads_Location_Type_AfterProfileService()
    {
        return $this->services['phpbb.ads.location.type.after_profile'] = new \phpbb\ads\location\type\after_profile(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.after_quickreply' shared service.
     *
     * @return \phpbb\ads\location\type\after_quickreply
     */
    protected function getPhpbb_Ads_Location_Type_AfterQuickreplyService()
    {
        return $this->services['phpbb.ads.location.type.after_quickreply'] = new \phpbb\ads\location\type\after_quickreply(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.before_posts' shared service.
     *
     * @return \phpbb\ads\location\type\before_posts
     */
    protected function getPhpbb_Ads_Location_Type_BeforePostsService()
    {
        return $this->services['phpbb.ads.location.type.before_posts'] = new \phpbb\ads\location\type\before_posts(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.before_profile' shared service.
     *
     * @return \phpbb\ads\location\type\before_profile
     */
    protected function getPhpbb_Ads_Location_Type_BeforeProfileService()
    {
        return $this->services['phpbb.ads.location.type.before_profile'] = new \phpbb\ads\location\type\before_profile(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.before_quickreply' shared service.
     *
     * @return \phpbb\ads\location\type\before_quickreply
     */
    protected function getPhpbb_Ads_Location_Type_BeforeQuickreplyService()
    {
        return $this->services['phpbb.ads.location.type.before_quickreply'] = new \phpbb\ads\location\type\before_quickreply(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.below_footer' shared service.
     *
     * @return \phpbb\ads\location\type\below_footer
     */
    protected function getPhpbb_Ads_Location_Type_BelowFooterService()
    {
        return $this->services['phpbb.ads.location.type.below_footer'] = new \phpbb\ads\location\type\below_footer(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.below_header' shared service.
     *
     * @return \phpbb\ads\location\type\below_header
     */
    protected function getPhpbb_Ads_Location_Type_BelowHeaderService()
    {
        return $this->services['phpbb.ads.location.type.below_header'] = new \phpbb\ads\location\type\below_header(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.pop_up' shared service.
     *
     * @return \phpbb\ads\location\type\pop_up
     */
    protected function getPhpbb_Ads_Location_Type_PopUpService()
    {
        return $this->services['phpbb.ads.location.type.pop_up'] = new \phpbb\ads\location\type\pop_up(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.scripts' shared service.
     *
     * @return \phpbb\ads\location\type\scripts
     */
    protected function getPhpbb_Ads_Location_Type_ScriptsService()
    {
        return $this->services['phpbb.ads.location.type.scripts'] = new \phpbb\ads\location\type\scripts(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type.slide_up' shared service.
     *
     * @return \phpbb\ads\location\type\slide_up
     */
    protected function getPhpbb_Ads_Location_Type_SlideUpService()
    {
        return $this->services['phpbb.ads.location.type.slide_up'] = new \phpbb\ads\location\type\slide_up(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.location.type_collection' shared service.
     *
     * @return \phpbb\di\service_collection
     */
    protected function getPhpbb_Ads_Location_TypeCollectionService()
    {
        $this->services['phpbb.ads.location.type_collection'] = $instance = new \phpbb\di\service_collection($this);

        $instance->add('phpbb.ads.location.type.above_footer');
        $instance->add('phpbb.ads.location.type.above_header');
        $instance->add('phpbb.ads.location.type.after_first_post');
        $instance->add('phpbb.ads.location.type.after_footer_navbar');
        $instance->add('phpbb.ads.location.type.after_header_navbar');
        $instance->add('phpbb.ads.location.type.after_not_first_post');
        $instance->add('phpbb.ads.location.type.after_posts');
        $instance->add('phpbb.ads.location.type.after_profile');
        $instance->add('phpbb.ads.location.type.after_quickreply');
        $instance->add('phpbb.ads.location.type.before_posts');
        $instance->add('phpbb.ads.location.type.before_profile');
        $instance->add('phpbb.ads.location.type.before_quickreply');
        $instance->add('phpbb.ads.location.type.below_footer');
        $instance->add('phpbb.ads.location.type.below_header');
        $instance->add('phpbb.ads.location.type.pop_up');
        $instance->add('phpbb.ads.location.type.scripts');
        $instance->add('phpbb.ads.location.type.slide_up');

        return $instance;
    }

    /**
     * Gets the private 'phpbb.ads.ucp.controller' shared service.
     *
     * @return \phpbb\ads\controller\ucp_controller
     */
    protected function getPhpbb_Ads_Ucp_ControllerService()
    {
        return $this->services['phpbb.ads.ucp.controller'] = new \phpbb\ads\controller\ucp_controller(${($_ = isset($this->services['phpbb.ads.ad.manager']) ? $this->services['phpbb.ads.ad.manager'] : $this->getPhpbb_Ads_Ad_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.ads.helper']) ? $this->services['phpbb.ads.helper'] : $this->getPhpbb_Ads_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.ads.visual_demo.controller' shared service.
     *
     * @return \phpbb\ads\controller\visual_demo_controller
     */
    protected function getPhpbb_Ads_VisualDemo_ControllerService()
    {
        return $this->services['phpbb.ads.visual_demo.controller'] = new \phpbb\ads\controller\visual_demo_controller(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php');
    }
    ...
    /**
     * Gets the private 'phpbb.googleanalytics.listener' shared service.
     *
     * @return \phpbb\googleanalytics\event\listener
     */
    protected function getPhpbb_Googleanalytics_ListenerService()
    {
        return $this->services['phpbb.googleanalytics.listener'] = new \phpbb\googleanalytics\event\listener(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'phpbb.mediaembed.cache' shared service.
     *
     * @return \phpbb\mediaembed\cache\cache
     */
    protected function getPhpbb_Mediaembed_CacheService()
    {
        return $this->services['phpbb.mediaembed.cache'] = new \phpbb\mediaembed\cache\cache(${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, '_text_formatter_parser', '_text_formatter_renderer');
    }

    /**
     * Gets the private 'phpbb.mediaembed.cron.task.purge_cache' shared service.
     *
     * @return \phpbb\mediaembed\cron\purge_cache
     */
    protected function getPhpbb_Mediaembed_Cron_Task_PurgeCacheService()
    {
        $this->services['phpbb.mediaembed.cron.task.purge_cache'] = $instance = new \phpbb\mediaembed\cron\purge_cache(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.mediaembed.cache']) ? $this->services['phpbb.mediaembed.cache'] : $this->getPhpbb_Mediaembed_CacheService()) && false ?: '_'});

        $instance->set_name('cron.task.mediaembed');

        return $instance;
    }

    /**
     * Gets the private 'phpbb.mediaembed.customsitescollection' shared service.
     *
     * @return \phpbb\mediaembed\collection\customsitescollection
     */
    protected function getPhpbb_Mediaembed_CustomsitescollectionService()
    {
        return $this->services['phpbb.mediaembed.customsitescollection'] = new \phpbb\mediaembed\collection\customsitescollection(${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.mediaembed.listener' shared service.
     *
     * @return \phpbb\mediaembed\event\main_listener
     */
    protected function getPhpbb_Mediaembed_ListenerService()
    {
        return $this->services['phpbb.mediaembed.listener'] = new \phpbb\mediaembed\event\main_listener(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['config_text']) ? $this->services['config_text'] : $this->getConfigTextService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.mediaembed.customsitescollection']) ? $this->services['phpbb.mediaembed.customsitescollection'] : $this->getPhpbb_Mediaembed_CustomsitescollectionService()) && false ?: '_'}, './cache/production/');
    }
    ...
    /**
     * Gets the private 'rmcgirr83.elonw.listener' shared service.
     *
     * @return \rmcgirr83\elonw\event\listener
     */
    protected function getRmcgirr83_Elonw_ListenerService()
    {
        return $this->services['rmcgirr83.elonw.listener'] = new \rmcgirr83\elonw\event\listener(${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'senky.massnotification.listener' shared service.
     *
     * @return \senky\massnotification\event\listener
     */
    protected function getSenky_Massnotification_ListenerService()
    {
        return $this->services['senky.massnotification.listener'] = new \senky\massnotification\event\listener(${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'});
    }

    /**
     * Gets the private 'senky.massnotification.notification.type.manual' service.
     *
     * @return \senky\massnotification\notification\type\manual
     */
    protected function getSenky_Massnotification_Notification_Type_ManualService()
    {
        $instance = new \senky\massnotification\notification\type\manual(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'phpBB_user_notifications');

        $instance->set_dispatcher(${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'});
        $instance->set_user_loader(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'});
    ...
    /**
     * Gets the private 'sitesplat.cloudflareip.listener' shared service.
     *
     * @return \sitesplat\cloudflareip\event\listener
     */
    protected function getSitesplat_Cloudflareip_ListenerService()
    {
        return $this->services['sitesplat.cloudflareip.listener'] = new \sitesplat\cloudflareip\event\listener(${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'vinny.shareon.listener' shared service.
     *
     * @return \vinny\shareon\event\listener
     */
    protected function getVinny_Shareon_ListenerService()
    {
        return $this->services['vinny.shareon.listener'] = new \vinny\shareon\event\listener(${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, 'php');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.thanks' => 'phpBB_thanks',
            'phpbb.ads.tables.ads' => 'phpBB_ads',
            'phpbb.ads.tables.ad_group' => 'phpBB_ad_group',
            'phpbb.ads.tables.ad_locations' => 'phpBB_ad_locations',
            'tables' => [
                ...
                'thanks' => 'phpBB_thanks',
                'ads' => 'phpBB_ads',
                'ad_group' => 'phpBB_ad_group',
                'ad_locations' => 'phpBB_ad_locations',
            ],
