...
$sql = array();
$sql[] = "INSERT INTO " . $table_prefix . "config(config_name, config_value) VALUES('newest_posts_first', '1')";
$sql[] = "ALTER TABLE " . $table_prefix . "users ADD user_post_order TINYINT(1) DEFAULT '1'";
