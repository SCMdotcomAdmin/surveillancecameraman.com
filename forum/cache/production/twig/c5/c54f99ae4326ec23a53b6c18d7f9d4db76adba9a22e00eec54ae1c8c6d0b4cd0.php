...
class __TwigTemplate_e1202a0340dec67e9d5b80c4e6f21f195e72dce67e9dfeeee547e68853bd157f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
        ...
        $this->env->loadTemplate('@rmcgirr83_elonw/event/ucp_prefs_personal_append.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        // line 76
        echo "\t</fieldset>
