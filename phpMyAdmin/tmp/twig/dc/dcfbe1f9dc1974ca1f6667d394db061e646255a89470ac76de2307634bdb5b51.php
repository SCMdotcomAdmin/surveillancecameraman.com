...
/* view_create.twig */
class __TwigTemplate_eb1ac6907c8b1d24922e7e3e3e29197aae5e56ed3ae9d422d34eff4acf5fa80c extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Details");
            ...
            // line 10
            echo "                ";
            if ((0 === twig_compare((($__internal_compile_0 = ($context["view"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["operation"] ?? null) : null), "create"))) {
                // line 11
                echo "                    ";
...
echo _gettext("Edit view");
        ...
        <table class=\"table align-middle rte_table\">
            ";
        // line 18
        if ((0 === twig_compare((($__internal_compile_1 = ($context["view"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["operation"] ?? null) : null), "create"))) {
            // line 19
            echo "                <tr>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            ...
            echo "\"
                                ";
            // line 35
            if ((0 === twig_compare((($__internal_compile_3 = ($context["view"] ?? null)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3["algorithm"] ?? null) : null), $context["option"]))) {
                // line 36
...
echo _gettext("Definer");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            ...
            echo "\"
                                ";
            // line 56
            if ((0 === twig_compare($context["option"], (($__internal_compile_5 = ($context["view"] ?? null)) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5["sql_security"] ?? null) : null)))) {
                echo " selected=\"selected\" ";
            }
            // line 57
            echo "                            >";
        ...
        echo "                    </select>
            ...
            ";
        // line 63
        if ((0 === twig_compare((($__internal_compile_6 = ($context["view"] ?? null)) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["operation"] ?? null) : null), "create"))) {
            // line 64
            echo "                <tr>
                    <td class=\"text-nowrap\">";
...
echo _gettext("Column names");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            ...
            echo "\"
                                ";
            // line 101
            if ((0 === twig_compare($context["option"], (($__internal_compile_11 = ($context["view"] ?? null)) && is_array($__internal_compile_11) || $__internal_compile_11 instanceof ArrayAccess ? ($__internal_compile_11["with"] ?? null) : null)))) {
                echo " selected=\"selected\" ";
            }
            // line 102
            echo "                            >";
    ...
    <input type=\"hidden\" name=\"";
        // line 112
        echo (((0 === twig_compare((($__internal_compile_12 = ($context["view"] ?? null)) && is_array($__internal_compile_12) || $__internal_compile_12 instanceof ArrayAccess ? ($__internal_compile_12["operation"] ?? null) : null), "create"))) ? ("createview") : ("alterview"));
        echo "\" value=\"1\" />

    ";
        // line 114
        if ((0 === twig_compare(($context["ajax_dialog"] ?? null), false))) {
            // line 115
...
";
    ...
    {
        return new Source("", "view_create.twig", "C:\\Users\\Master\\Desktop\\1uploadway\\phpMyAdmin\\templates\\view_create.twig");
    }
}
